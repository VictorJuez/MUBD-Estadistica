...
- Principal Component Analysis (PCA): Nos hemos quedado con las 10 componentes principales en vez de utilizar las más de 500 características que tienen el conjunto de datos.
...
## Representación gráfica y análisis del resultado
...
Vemos que `K = 3` es lo que mejor resultado da, con un `0.9622016` de capacidad predictiva.
